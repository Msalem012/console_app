class MemoryMonitor {
  ...
  static getMemoryUsage() {
    ...
    return {
      ...
      heapTotal: this.formatBytes(usage.heapTotal), // Total heap
      heapUsed: this.formatBytes(usage.heapUsed), // Used heap
      external: this.formatBytes(usage.external), // External memory
